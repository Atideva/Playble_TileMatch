...
namespace Watermelon
{
    public class UIComplete : UIPage
    {
        ...
        public override void PlayShowAnimation()
        {
            ...
            {
                rewardLabel.RectTransform
                    .DOPushScale(Vector3.one * 1.1f, Vector3.one, 0.2f, 0.2f)
                    .OnComplete(delegate
                    {
        ...
        public void ShowRewardLabel(float rewardAmounts, bool immediately = false, float duration = 0.3f, Action onComplted = null)
        {
            ...
            Tween.DoFloat(0, rewardAmounts, duration, (float value) => { rewardAmountText.text = "+" + (int) value; }).OnComplete(delegate { onComplted?.Invoke(); });
        }
        ...
        public void NextLevelButton()
        {
            ...
            else
            {
                ...
                UIController.HidePage<UIComplete>(() => { GameController.LoadNextLevel(); });
            }
        }
        ...
        public void HomeButton()
        {
            ...
            UIController.HidePage<UIComplete>(() => { GameController.ReturnToMenu(); });
        }
